...
# Paramètre de caméra
CAMERA_ID = 0  # 0=webcam intégrée, 1=webcam externe, 2=autre caméra, etc.

# Paramètres vidéo pour OBS
VIDEO_SOURCE_NAME = "Wazzup Beijing"  # Nom de votre source média dans OBS
VIDEO_PATH = r"C:\Users\chats\Videos\Wazzup Beijing.mp4"  # Chemin vers votre fichier vidéo
